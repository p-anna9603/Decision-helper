...
namespace DecisionSupport
{
    public partial class firstForm : Form
    {
        ...
        private Form currentChildForm; // holds only the Form1 type
        string hiddenChild = "";
        int newProject = 0;
        ...
        private void newProjIcon_Click(object sender, EventArgs e)
        {
            ...
            else // if there was no loaded project
            {
                ActivateButton(sender, RGBColors.color4);
        ...
        private void LoadProjIcon_Click(object sender, EventArgs e)
        {
            ...
            if (form1 != null && form1.getTablesCount() > 0 && form1.getModification() == 0) // if there was already a loaded project
            {
                ...
                {
                    form1.Saving = 1;
                    Console.WriteLine("save: " + form1.getSaving());
                    form1.Close();
                    form1.clearEverything();
                    removeIconTitle();
                    form1 = new Form1();
            ...
            {
                Form1 formBackup = null;
                if (form1 != null && form1.getTablesCount() > 0 && form1.getModification() == 1)
                {
                    formBackup = form1;
                }
                ...
                else // if load project action was aborted or canceled
                {
                    //if (formBackup != null) // it is a very big error
                    //{
                    //    form1 = formBackup;
                    //    OpenChildForm(form1);
                    //    formBackup = null;
        ...
        public void projectCancelClicked(object sender, EventArgs e)
        {
            ...
            {
                form1.Saving = 1;
                Console.WriteLine("save 2: " + form1.getSaving());
                closeProject();
            }
            else if (result == DialogResult.Cancel)
            {
        ...
        {
            ActivateButton(sender, RGBColors.color4);
            if (hiddenChild.Equals("ShowOpts")) // TODO Delete this hiddenChild is just for Form1 type
            {
                panelDesktop.Show();
                elementHost1.Show();
                hiddenChild = "";
        ...
        private void firstForm_Resize(object sender, EventArgs e)
        {
            ...
            if (currentChildForm != null && shownWindow == 0)
            {
                resizeChildForm();
            }
